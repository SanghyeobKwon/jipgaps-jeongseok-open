...
export default function Home() {
  ...
  const chooseMapDong = useCallback((dong: string) => { const legalDong = legalDongName(dong); setSelectedBoundaryDong(dong); setMapFocus("buildings"); resetPropertySelection(); setSelectedDong(legalDong || dong); }, [resetPropertySelection]);
